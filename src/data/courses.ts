...
export const courses: Course[] = [
  {
    ...
    lessons: [
      ...
      { id: 10, titleKey: 'Level 1 Assessment', duration: 20, isCompleted: false, isLocked: true, isFree: false },
    ]
  },
  {
    id: 2,
    ...
    currency: '₹',
    lessons: [
      { id: 11, titleKey: 'Advanced Counting', duration: 20, isCompleted: false, isLocked: false, isFree: true },
      { id: 12, titleKey: 'Addition Strategies', duration: 25, isCompleted: false, isLocked: false, isFree: true },
      { id: 13, titleKey: 'Speed Practice', duration: 22, isCompleted: false, isLocked: true, isFree: false },
      { id: 14, titleKey: 'Complement Numbers', duration: 28, isCompleted: false, isLocked: true, isFree: false },
      { id: 15, titleKey: 'Mental Math Basics', duration: 30, isCompleted: false, isLocked: true, isFree: false },
      { id: 16, titleKey: 'Pattern Recognition', duration: 26, isCompleted: false, isLocked: true, isFree: false },
      { id: 17, titleKey: 'Advanced Bead Techniques', duration: 32, isCompleted: false, isLocked: true, isFree: false },
      { id: 18, titleKey: 'Practice Session 2', duration: 35, isCompleted: false, isLocked: true, isFree: false },
      { id: 19, titleKey: 'Speed Challenges', duration: 25, isCompleted: false, isLocked: true, isFree: false },
      { id: 20, titleKey: 'Games and Activities', duration: 40, isCompleted: false, isLocked: true, isFree: false },
      { id: 21, titleKey: 'Review and Practice', duration: 30, isCompleted: false, isLocked: true, isFree: false },
      { id: 22, titleKey: 'Level 2 Assessment', duration: 25, isCompleted: false, isLocked: true, isFree: false },
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 46, titleKey: 'Level 4 Assessment', duration: 35, isCompleted: false, isLocked: true, isFree: false },
    ]
  },
  {
    id: 5,
    ...
    currency: '₹',
    lessons: [
      { id: 47, titleKey: 'Multiplication Introduction', duration: 30, isCompleted: false, isLocked: false, isFree: true },
      { id: 48, titleKey: 'Times Tables on Abacus', duration: 35, isCompleted: false, isLocked: false, isFree: true },
      { id: 49, titleKey: 'Single Digit Multiplication', duration: 40, isCompleted: false, isLocked: true, isFree: false },
      { id: 50, titleKey: 'Two Digit Multiplication', duration: 45, isCompleted: false, isLocked: true, isFree: false },
      { id: 51, titleKey: 'Advanced Techniques', duration: 42, isCompleted: false, isLocked: true, isFree: false },
      { id: 52, titleKey: 'Speed Methods', duration: 50, isCompleted: false, isLocked: true, isFree: false },
      { id: 53, titleKey: 'Pattern Recognition', duration: 38, isCompleted: false, isLocked: true, isFree: false },
      { id: 54, titleKey: 'Problem Solving', duration: 48, isCompleted: false, isLocked: true, isFree: false },
      { id: 55, titleKey: 'Practice Session 5', duration: 55, isCompleted: false, isLocked: true, isFree: false },
      { id: 56, titleKey: 'Real-World Math', duration: 45, isCompleted: false, isLocked: true, isFree: false },
      { id: 57, titleKey: 'Championship Practice', duration: 60, isCompleted: false, isLocked: true, isFree: false },
      { id: 58, titleKey: 'Level 5 Assessment', duration: 40, isCompleted: false, isLocked: true, isFree: false },
    ]
  },
  {
    id: 6,
    ...
    currency: '₹',
    lessons: [
      { id: 59, titleKey: 'Master Level Introduction', duration: 35, isCompleted: false, isLocked: false, isFree: true },
      { id: 60, titleKey: 'Complex Calculations', duration: 40, isCompleted: false, isLocked: false, isFree: true },
      { id: 61, titleKey: 'Mental Math Mastery', duration: 45, isCompleted: false, isLocked: true, isFree: false },
      { id: 62, titleKey: 'Advanced Division', duration: 50, isCompleted: false, isLocked: true, isFree: false },
      { id: 63, titleKey: 'Decimal Operations', duration: 48, isCompleted: false, isLocked: true, isFree: false },
      { id: 64, titleKey: 'Fraction Calculations', duration: 52, isCompleted: false, isLocked: true, isFree: false },
      { id: 65, titleKey: 'Speed Championships', duration: 60, isCompleted: false, isLocked: true, isFree: false },
      { id: 66, titleKey: 'Competition Preparation', duration: 55, isCompleted: false, isLocked: true, isFree: false },
      { id: 67, titleKey: 'Advanced Problem Solving', duration: 50, isCompleted: false, isLocked: true, isFree: false },
      { id: 68, titleKey: 'Real-World Applications', duration: 48, isCompleted: false, isLocked: true, isFree: false },
      { id: 69, titleKey: 'Teaching Others', duration: 45, isCompleted: false, isLocked: true, isFree: false },
      { id: 70, titleKey: 'Master Practice Session', duration: 65, isCompleted: false, isLocked: true, isFree: false },
      { id: 71, titleKey: 'Final Challenges', duration: 60, isCompleted: false, isLocked: true, isFree: false },
      { id: 72, titleKey: 'Certification Prep', duration: 40, isCompleted: false, isLocked: true, isFree: false },
      { id: 73, titleKey: 'Master Assessment', duration: 45, isCompleted: false, isLocked: true, isFree: false },
    ]
  }
];